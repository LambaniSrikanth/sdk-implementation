...
const app = express();
const { register, forgotPassword, forgotPasswordByToken, verifyEmailByToken, verifyMobileByOTP, sendOTPForMobileVerification } = require("./registration")
const { getProfileDetailsByAccessId, InvalidateAccessToken, login } = require("./login")
